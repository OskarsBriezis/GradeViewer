    ...
    <div class="py-6 max-w-3xl mx-auto sm:px-6 lg:px-8">
        <form method="POST" action="{{ route('students.update', $student) }}">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="first_name" id="first_name" value="{{ old('first_name', $student->first_name) }}" required class="w-full border p-2 rounded" />
            ...
            <div class="mb-4">
                ...
                <input type="text" name="last_name" id="last_name" value="{{ old('last_name', $student->last_name) }}" required class="w-full border p-2 rounded" />
